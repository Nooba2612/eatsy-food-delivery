        ...
        <div className={cx("phone-input-wrapper")}>
          ...
          >
            ...
            <div className={cx("select-input-content")}>
              ...
              ></div>
              <ExpandMore
                className={cx("more-icon", { active: isOpenDropdown })}
              />
      ...
      <div className={cx("social-login-buttons-group")}>
        ...
        >
          <div
            className={cx("logo")}
            style={{
              backgroundImage: `url(${require("@images/logos/google-logo.webp")})`,
            }}
          ></div>
        ...
        >
          <div
            className={cx("logo")}
            style={{
              backgroundImage: `url(${require("@images/logos/facebook-logo.webp")})`,
            }}
          ></div>
        ...
        <button type="button" className={cx("apple-login-btn")}>
          <div
            className={cx("logo")}
            style={{
              backgroundImage: `url(${require("@images/logos/apple-logo.png")})`,
            }}
          ></div>
