...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\hanay\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.350\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '203fbc4db1e9bdf672e0b4GUhITR5eUAkBAVsBUAJTCgNRVAUD'}); } catch(cjsError) { try { import('file:///c:/Users/hanay/.vscode/extensions/wallabyjs.console-ninja-1.0.350/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '203fbc4db1e9bdf672e0b4GUhITR5eUAkBAVsBUAJTCgNRVAUD'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
